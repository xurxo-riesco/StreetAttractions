...
@interface ComposeViewController ()<UIPickerViewDelegate,
...
- (IBAction)onPost:(id)sender
{
  ...
  if (readyToPost) {
    ...
    [Post postUserImage:self.image
            withCaption:self.descriptionText.text
            forLatitude:self.latitude
           forLongitude:self.longitude
             toCategory:self.category
             isUpcoming:upcoming
                forDate:self.upcomingDate
              withVideo:self.hasVideo
